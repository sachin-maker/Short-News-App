...
//                    Toast.makeText(getApplicationContext(), E.getMessage(), Toast.LENGTH_LONG).show();
        ...
        protected void onPostExecute(Boolean result) {
            ...
            for (int i=0; i<5; i++)
            {
                ...
                Intent intentToRepeat = new Intent(mContext, com.sachin.newsapp.NewsWebView.class);
...
//                    NotificationHelper.getNotificationManager(mContext).notify(NotificationHelper.ALARM_TYPE_RTC, repeatedNotification);
                    ...
                    com.sachin.newsapp.NotificationHelper.getNotificationManager(mContext).notify(m, repeatedNotification);
